...
type Message[RI any] interface {
	...
	CheckSize(limits ocr3types.OCR3PluginLimits) bool
...
// MessageToOutcomeGeneration is the interface used to pass an inter-oracle message
// to the local oracle reporting process.
type MessageToOutcomeGeneration[RI any] interface {
	Message[RI]

	// processOutcomeGeneration is called to send this message to the local oracle
	// reporting process.
...
// MessageToOutcomeGenerationWithSender records a message destined for the oracle
// reporting
...
func (msg MessageNewEpoch[RI]) CheckSize(ocr3types.OCR3PluginLimits) bool {
	return true
}
...
func (msg MessageEpochStartRequest[RI]) CheckSize(ocr3types.OCR3PluginLimits) bool {
	return true
}
...
func (msg MessageEpochStart[RI]) CheckSize(ocr3types.OCR3PluginLimits) bool {
	return true
}
...
// MessageRoundStart corresponds to the "observe-req" message from alg. 2. The
...
func (msg MessageRoundStart[RI]) CheckSize(limits ocr3types.OCR3PluginLimits) bool {
...
// MessageObservation corresponds to the "observe" message from alg. 2.
...
func (msg MessageObservation[RI]) CheckSize(limits ocr3types.OCR3PluginLimits) bool {
	return len(msg.SignedObservation.Observation) <= limits.MaxObservationLength
}
...
func (msg MessageProposal[RI]) CheckSize(limits ocr3types.OCR3PluginLimits) bool {
...
func (msg MessagePrepare[RI]) CheckSize(ocr3types.OCR3PluginLimits) bool {
	return true
}
...
func (msg MessageCommit[RI]) CheckSize(ocr3types.OCR3PluginLimits) bool {
	return true
}
...
func (msg MessageReportSignatures[RI]) CheckSize(limits ocr3types.OCR3PluginLimits) bool {
	return len(msg.ReportSignatures) <= limits.MaxReportCount
...
func (msg MessageCertifiedCommitRequest[RI]) CheckSize(ocr3types.OCR3PluginLimits) bool {
	return true
}
...
func (msg MessageCertifiedCommit[RI]) CheckSize(ocr3types.OCR3PluginLimits) bool {
	return true
}
