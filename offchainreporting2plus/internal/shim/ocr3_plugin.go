...
type LimitCheckOCR3Plugin[RI any] struct {
	Plugin ocr3types.OCR3Plugin[RI]
	Limits ocr3types.OCR3PluginLimits
}

var _ ocr3types.OCR3Plugin[struct{}] = LimitCheckOCR3Plugin[struct{}]{}
...
func (rp LimitCheckOCR3Plugin[RI]) ShouldAcceptFinalizedReport(ctx context.Context, seqNr uint64, report ocr3types.ReportWithInfo[RI]) (bool, error) {
	return rp.Plugin.ShouldAcceptFinalizedReport(ctx, seqNr, report)
}
